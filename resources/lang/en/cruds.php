...
return [
    ...
    'template' => [
        ...
        'fields'         => [
            ...
            'select_template_helper' => 'Select the existing template you wan to use for this campaign',
        ],
    ],
    'mailRoom' => [
        'title'          => 'Mail Room',
    ...
    'mailHistory' => [
        'title'          => 'Mail History',
        'title_singular' => 'Mail History',
        'fields'         => [
            'id'                     => 'ID',
            'id_helper'              => ' ',
            'posted_campaign'        => 'Posted Campaign Name',
            'posted_campaign_helper' => 'please select the template name and email subject',
            'time_sent'              => 'Time Sent',
            'time_sent_helper'       => ' ',
