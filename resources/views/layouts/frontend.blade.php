                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @can('affiliate_access')
                                        <a class="dropdown-item" href="{{ route('frontend.affiliates.index') }}">
                                            {{ trans('cruds.affiliate.title') }}
                                        </a>
                                    @endcan
                                    @can('advertiser_access')
                                        <a class="dropdown-item" href="{{ route('frontend.advertisers.index') }}">
                                    ...
                                    @endcan
                                    @can('balance_access')
                                        <a class="dropdown-item" href="{{ route('frontend.balances.index') }}">
                                            {{ trans('cruds.balance.title') }}
                                        </a>
                                    @endcan
                                    @can('mail_room_access')
                                        <a class="dropdown-item" href="{{ route('frontend.mail-rooms.index') }}">
                                    ...
                                    @can('account_status_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.account-statuses.index') }}">
                                            {{ trans('cruds.accountStatus.title') }}
                                        </a>
                                    @endcan
                                    @can('label_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.labels.index') }}">
                                            {{ trans('cruds.label.title') }}
                                        </a>
                                    @endcan
                                    @can('payment_status_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.payment-statuses.index') }}">
