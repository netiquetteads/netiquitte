    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.affiliates.update", [$affiliate->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('account_manager_name') ? 'is-invalid' : '' }}" type="text" name="account_manager_name" id="account_manager_name" value="{{ old('account_manager_name', $affiliate->account_manager_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('last_login') ? 'is-invalid' : '' }}" type="text" name="last_login" id="last_login" value="{{ old('last_login', $affiliate->last_login) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('network_country_code') ? 'is-invalid' : '' }}" type="text" name="network_country_code" id="network_country_code" value="{{ old('network_country_code', $affiliate->network_country_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('global_tracking_domain_url') ? 'is-invalid' : '' }}" type="text" name="global_tracking_domain_url" id="global_tracking_domain_url" value="{{ old('global_tracking_domain_url', $affiliate->global_tracking_domain_url) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('network_affiliateid') ? 'is-invalid' : '' }}" type="number" name="network_affiliateid" id="network_affiliateid" value="{{ old('network_affiliateid', $affiliate->network_affiliateid) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('account_executiveid') ? 'is-invalid' : '' }}" type="number" name="account_executiveid" id="account_executiveid" value="{{ old('account_executiveid', $affiliate->account_executiveid) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('account_managerid') ? 'is-invalid' : '' }}" type="number" name="account_managerid" id="account_managerid" value="{{ old('account_managerid', $affiliate->account_managerid) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('networkid') ? 'is-invalid' : '' }}" type="number" name="networkid" id="networkid" value="{{ old('networkid', $affiliate->networkid) }}" step="1">
