...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.campaignResult.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.campaign-results.update", [$campaignResult->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('campaign') ? 'is-invalid' : '' }}" name="campaign_id" id="campaign_id">
                    @foreach($campaigns as $id => $entry)
                        <option value="{{ $id }}" {{ (old('campaign_id') ? old('campaign_id') : $campaignResult->campaign->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('time_sent') ? 'is-invalid' : '' }}" type="text" name="time_sent" id="time_sent" value="{{ old('time_sent', $campaignResult->time_sent) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('emails_sent') ? 'is-invalid' : '' }}" type="number" name="emails_sent" id="emails_sent" value="{{ old('emails_sent', $campaignResult->emails_sent) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('list') ? 'is-invalid' : '' }}" type="text" name="list" id="list" value="{{ old('list', $campaignResult->list) }}">
                @if($errors->has('list'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('opens') ? 'is-invalid' : '' }}" type="number" name="opens" id="opens" value="{{ old('opens', $campaignResult->opens) }}" step="1">
                @if($errors->has('opens'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unopened') ? 'is-invalid' : '' }}" type="number" name="unopened" id="unopened" value="{{ old('unopened', $campaignResult->unopened) }}" step="1">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('email_template') ? 'is-invalid' : '' }}" name="email_template" id="email_template">{{ old('email_template', $campaignResult->email_template) }}</textarea>
