        ...
        <form method="POST" action="{{ route("admin.advertisers.update", [$advertiser->id]) }}" enctype="multipart/form-data">
           ...
           <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('account_manager_name') ? 'is-invalid' : '' }}" type="text" name="account_manager_name" id="account_manager_name" value="{{ old('account_manager_name', $advertiser->account_manager_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('account_executive_name') ? 'is-invalid' : '' }}" type="text" name="account_executive_name" id="account_executive_name" value="{{ old('account_executive_name', $advertiser->account_executive_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('balance') ? 'is-invalid' : '' }}" type="number" name="balance" id="balance" value="{{ old('balance', $advertiser->balance) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('last_login') ? 'is-invalid' : '' }}" type="text" name="last_login" id="last_login" value="{{ old('last_login', $advertiser->last_login) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('network_country_code') ? 'is-invalid' : '' }}" type="text" name="network_country_code" id="network_country_code" value="{{ old('network_country_code', $advertiser->network_country_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('global_tracking_domain_url') ? 'is-invalid' : '' }}" type="text" name="global_tracking_domain_url" id="global_tracking_domain_url" value="{{ old('global_tracking_domain_url', $advertiser->global_tracking_domain_url) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('account_executiveid') ? 'is-invalid' : '' }}" type="number" name="account_executiveid" id="account_executiveid" value="{{ old('account_executiveid', $advertiser->account_executiveid) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('account_managerid') ? 'is-invalid' : '' }}" type="number" name="account_managerid" id="account_managerid" value="{{ old('account_managerid', $advertiser->account_managerid) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('networkid') ? 'is-invalid' : '' }}" type="number" name="networkid" id="networkid" value="{{ old('networkid', $advertiser->networkid) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('network_employeeid') ? 'is-invalid' : '' }}" type="number" name="network_employeeid" id="network_employeeid" value="{{ old('network_employeeid', $advertiser->network_employeeid) }}" step="1">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_contact_address_enabled') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_contact_address_enabled" id="is_contact_address_enabled" value="1" {{ $advertiser->is_contact_address_enabled || old('is_contact_address_enabled', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sales_managerid') ? 'is-invalid' : '' }}" type="number" name="sales_managerid" id="sales_managerid" value="{{ old('sales_managerid', $advertiser->sales_managerid) }}" step="1">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_expose_publisher_reporting_data') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_expose_publisher_reporting_data" id="is_expose_publisher_reporting_data" value="1" {{ $advertiser->is_expose_publisher_reporting_data || old('is_expose_publisher_reporting_data', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('platform_name') ? 'is-invalid' : '' }}" type="text" name="platform_name" id="platform_name" value="{{ old('platform_name', $advertiser->platform_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('platform_url') ? 'is-invalid' : '' }}" type="text" name="platform_url" id="platform_url" value="{{ old('platform_url', $advertiser->platform_url) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('platform_username') ? 'is-invalid' : '' }}" type="text" name="platform_username" id="platform_username" value="{{ old('platform_username', $advertiser->platform_username) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('accounting_contact_email') ? 'is-invalid' : '' }}" type="email" name="accounting_contact_email" id="accounting_contact_email" value="{{ old('accounting_contact_email', $advertiser->accounting_contact_email) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('offer_id_macro') ? 'is-invalid' : '' }}" type="text" name="offer_id_macro" id="offer_id_macro" value="{{ old('offer_id_macro', $advertiser->offer_id_macro) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('affiliate_id_macro') ? 'is-invalid' : '' }}" type="text" name="affiliate_id_macro" id="affiliate_id_macro" value="{{ old('affiliate_id_macro', $advertiser->affiliate_id_macro) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('attribution_method') ? 'is-invalid' : '' }}" type="text" name="attribution_method" id="attribution_method" value="{{ old('attribution_method', $advertiser->attribution_method) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_attribution_method') ? 'is-invalid' : '' }}" type="text" name="email_attribution_method" id="email_attribution_method" value="{{ old('email_attribution_method', $advertiser->email_attribution_method) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('network_advertiserid') ? 'is-invalid' : '' }}" type="number" name="network_advertiserid" id="network_advertiserid" value="{{ old('network_advertiserid', $advertiser->network_advertiserid) }}" step="1">
