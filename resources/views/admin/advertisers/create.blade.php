    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.advertisers.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sales_manager_name') ? 'is-invalid' : '' }}" type="text" name="sales_manager_name" id="sales_manager_name" value="{{ old('sales_manager_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('today_revenue') ? 'is-invalid' : '' }}" type="text" name="today_revenue" id="today_revenue" value="{{ old('today_revenue', '') }}">
