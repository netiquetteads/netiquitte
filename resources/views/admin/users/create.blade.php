    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('work_phone') ? 'is-invalid' : '' }}" type="text" name="work_phone" id="work_phone" value="{{ old('work_phone', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cell_phone') ? 'is-invalid' : '' }}" type="text" name="cell_phone" id="cell_phone" value="{{ old('cell_phone', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('instant_messaginid') ? 'is-invalid' : '' }}" type="number" name="instant_messaginid" id="instant_messaginid" value="{{ old('instant_messaginid', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('instant_messaging_identifier') ? 'is-invalid' : '' }}" type="text" name="instant_messaging_identifier" id="instant_messaging_identifier" value="{{ old('instant_messaging_identifier', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('labels') ? 'is-invalid' : '' }}" name="labels[]" id="labels" multiple>
                    @foreach($labels as $id => $labels)
                        <option value="{{ $id }}" {{ in_array($id, old('labels', [])) ? 'selected' : '' }}>{{ $labels }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('adertisers') ? 'is-invalid' : '' }}" name="adertisers[]" id="adertisers" multiple>
                    @foreach($adertisers as $id => $adertisers)
                        <option value="{{ $id }}" {{ in_array($id, old('adertisers', [])) ? 'selected' : '' }}>{{ $adertisers }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('affiliates') ? 'is-invalid' : '' }}" name="affiliates[]" id="affiliates" multiple>
                    @foreach($affiliates as $id => $affiliates)
                        <option value="{{ $id }}" {{ in_array($id, old('affiliates', [])) ? 'selected' : '' }}>{{ $affiliates }}</option>
                    @endforeach
                </select>
