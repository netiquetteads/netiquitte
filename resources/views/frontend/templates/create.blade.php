                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.templates.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="email_subject" id="email_subject" value="{{ old('email_subject', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" name="from_email" id="from_email" value="{{ old('from_email') }}">
