                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.templates.update", [$template->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="email_subject" id="email_subject" value="{{ old('email_subject', $template->email_subject) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" name="from_email" id="from_email" value="{{ old('from_email', $template->from_email) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="content" id="content">{!! old('content', $template->content) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="needsclick dropzone" id="offer_image-dropzone">
                            </div>
                            @if($errors->has('offer_image'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('offer_image') }}
                                </div>
                            @endif
