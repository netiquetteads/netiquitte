                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.payment-methods.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="routing_number" id="routing_number" value="{{ old('routing_number', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" name="paypal_email" id="paypal_email" value="{{ old('paypal_email') }}">
