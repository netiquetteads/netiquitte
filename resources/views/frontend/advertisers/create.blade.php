    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.advertisers.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="everflow_account" id="everflow_account" value="{{ old('everflow_account', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="account_manager_name" id="account_manager_name" value="{{ old('account_manager_name', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="account_executive_name" id="account_executive_name" value="{{ old('account_executive_name', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="last_login" id="last_login" value="{{ old('last_login') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="network_country_code" id="network_country_code" value="{{ old('network_country_code', 'US') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="global_tracking_domain_url" id="global_tracking_domain_url" value="{{ old('global_tracking_domain_url', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="today_revenue" id="today_revenue" value="{{ old('today_revenue', '0.00') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="network_affiliateid" id="network_affiliateid" value="{{ old('network_affiliateid', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="account_executiveid" id="account_executiveid" value="{{ old('account_executiveid', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="account_managerid" id="account_managerid" value="{{ old('account_managerid', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="networkid" id="networkid" value="{{ old('networkid', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="network_employeeid" id="network_employeeid" value="{{ old('network_employeeid', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="internal_notes" id="internal_notes">{{ old('internal_notes') }}</textarea>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_contact_address_enabled" id="is_contact_address_enabled" value="1" {{ old('is_contact_address_enabled', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="sales_managerid" id="sales_managerid" value="{{ old('sales_managerid', '') }}" step="1">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_expose_publisher_reporting_data" id="is_expose_publisher_reporting_data" value="1" {{ old('is_expose_publisher_reporting_data', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="platform_name" id="platform_name" value="{{ old('platform_name', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="platform_url" id="platform_url" value="{{ old('platform_url', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="platform_username" id="platform_username" value="{{ old('platform_username', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" name="accounting_contact_email" id="accounting_contact_email" value="{{ old('accounting_contact_email') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="offer_id_macro" id="offer_id_macro" value="{{ old('offer_id_macro', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="affiliate_id_macro" id="affiliate_id_macro" value="{{ old('affiliate_id_macro', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="attribution_method" id="attribution_method" value="{{ old('attribution_method', 'last_touch') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="email_attribution_method" id="email_attribution_method" value="{{ old('email_attribution_method', 'last_affiliate_attribution') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="network_advertiserid" id="network_advertiserid" value="{{ old('network_advertiserid', '') }}" step="1">
