                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.offers.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="network_offer" id="network_offer" value="{{ old('network_offer', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="network" id="network" value="{{ old('network', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="optimized_thumbnail_url" id="optimized_thumbnail_url" value="{{ old('optimized_thumbnail_url', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="thumbnail_url" id="thumbnail_url" value="{{ old('thumbnail_url', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="visibility" id="visibility" value="{{ old('visibility', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="network_advertiser_name" id="network_advertiser_name" value="{{ old('network_advertiser_name', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="network_offer_group" id="network_offer_group" value="{{ old('network_offer_group', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="time_created" id="time_created" value="{{ old('time_created') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="time_saved" id="time_saved" value="{{ old('time_saved') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="today_revenue" id="today_revenue" value="{{ old('today_revenue', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="destination_url" id="destination_url" value="{{ old('destination_url', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="today_clicks" id="today_clicks" value="{{ old('today_clicks', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="revenue_type" id="revenue_type" value="{{ old('revenue_type', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="payout_type" id="payout_type" value="{{ old('payout_type', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="today_payout_amount" id="today_payout_amount" value="{{ old('today_payout_amount', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="today_revenue_amount" id="today_revenue_amount" value="{{ old('today_revenue_amount', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="payout_amount" id="payout_amount" value="{{ old('payout_amount', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="revenue_amount" id="revenue_amount" value="{{ old('revenue_amount', '') }}" step="1">
