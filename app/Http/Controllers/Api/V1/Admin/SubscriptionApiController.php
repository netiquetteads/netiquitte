...
class SubscriptionApiController extends Controller
{
    public function index()
    {
        ...
        return new SubscriptionResource(Subscription::with(['subscriber', 'offer_subscription'])->get());
    }
    ...
    public function show(Subscription $subscription)
    {
        ...
        return new SubscriptionResource($subscription->load(['subscriber', 'offer_subscription']));
    }
